...
* Boolean values - Toggles true/false, on/off, yes/no (e.g. Objective-C)
...
* Strings wrapped in single/double quotes - Shifts to alphabetically next/previous quoted string found in current document
