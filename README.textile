...
* Selected JsDoc block: Convert "@return" into "@returns", add curly brackets around data types in "@param" and "@returns" lines, correct invalid data types into existing primitive data types (event => Object, int(eger) => number), reduce two successive empty JsDoc lines into a single empty line
