...
h3. Supported generic shifting types
...
* Selection which is a Sizzle-Selector - Converts the selector into a corresponding variable declaration
* Selection of multiple var declarations in succession - are joined into multiple comma-separated declarations


h3. Dictionaric keyword shifting
