...
* 1.5.1
    ** Added: Shifting a selected PHP doc comment block that contains @param comments w/ variable name but no data type, guesses and inserts data type types
    ** Added: Shifting while caret is inside a PHP doc comment @param line that contains no data type, guesses and inserts a data type by the variable name
