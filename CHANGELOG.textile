...
* 1.5.5
    ** Added: popup to select mode when selection is both: sortable list, swappable quote signs
    ** Added: popup to select mode when selection is both: PHP concatenation (order can be toggled), swappable quote signs
* 1.5.4
