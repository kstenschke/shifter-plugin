...
* 1.5.3
    ** Bugfix: Fixed null pointer exception on Ubuntu during plugin initialization. Thanks to Vojtěch Krasa
* 1.5.2
...
* 1.5.1
    ...
    ** Bugfix: Toggeling tupel items order was taking precedence over switching single vs. double quotes
* 1.5.0
