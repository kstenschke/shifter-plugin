...
* 1.7.0
    ...
    ** Added: Sort all attributes of selected selectors in a CSS (or LESS or SASS) stylesheet selection (alphabetically, vendor-attributes and vendor-styles at the end)
    ** Added: Sort selected attribute-style lines in a CSS (or LESS or SASS) stylesheet (alphabetically, vendor-attributes and vendor-styles at the end)
    ...
    ** Improved: More omitted JsDoc data types (also invalid) are detected from argument names
* 1.6.1
