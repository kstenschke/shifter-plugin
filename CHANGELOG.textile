...
* 1.7.0
    ...
    ** Added: Sort all attributes-style lines inside selected selectors in a CSS (or LESS or SASS) stylesheet selection (alphabetically, vendor-attributes and vendor-styles at the end)
    ...
    ** Improved: Better shifting of single-lined PHP DOC block comments
