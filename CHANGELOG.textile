...
* 1.7.2
    ...
    ** Added: Plugin setting to enable/disable quote conversions (1. single quotes to double, 2. double quotes to single)
    ** Added: Plugin setting to enable/disable PHP array syntax conversions (1. long to short, 2. short to long)
...
* 1.7.1
    ...
    ** Improved: PHP DOC @param data type insertion - can now also be invoked on selected line of DOC comment block
...
* 1.7.0
    ...
    ** Improved: Shifting of single-lined PHP DOC block comments
    ...
    ** Improved: More PHP DOC and JsDoc data types detection from argument names
