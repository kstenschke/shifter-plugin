...
public class ShiftableTypesManager {
    ...
    // Word type objects
    private com.kstenschke.shifter.models.shiftable.types.StaticWordType wordTypeAccessibilities;
    private DictionaryTerm typeDictionaryTerm;

    // Generic types (calculated when shifted)
    private com.kstenschke.shifter.models.shiftable.types.CssUnit typePixelValue;
    private com.kstenschke.shifter.models.shiftable.types.DocCommentTag typeTagInDocComment;
    private com.kstenschke.shifter.models.shiftable.types.DocCommentType typeDataTypeInDocComment;
    private com.kstenschke.shifter.models.shiftable.types.NumericValue typeNumericValue;
    private OperatorSign typeOperatorSign;
    private com.kstenschke.shifter.models.shiftable.types.PhpVariable typePhpVariable;
    private com.kstenschke.shifter.models.shiftable.types.RbgColor typeRgbColor;
    private RomanNumber typeRomanNumber;
    private StringMonoCharacter typeMonoCharacterString;
    private Tupel wordsTupel;
    private com.kstenschke.shifter.models.shiftable.types.QuotedString typeQuotedString;
...
//            return TYPE_PHP_DOC_PARAM_LINE;
        ...
        this.typePhpVariable = new com.kstenschke.shifter.models.shiftable.types.PhpVariable();
        ...
        this.typeDataTypeInDocComment = new com.kstenschke.shifter.models.shiftable.types.DocCommentType();
        if (this.typeDataTypeInDocComment.isDocCommentTypeLineContext(line)) {
            this.typeTagInDocComment = new com.kstenschke.shifter.models.shiftable.types.DocCommentTag();
        ...
        this.typeQuotedString = new com.kstenschke.shifter.models.shiftable.types.QuotedString();
        if (this.typeQuotedString.isQuotedString(prefixChar, postfixChar)) {
            return TYPE_QUOTED_STRING;
        }
        // RGB (must be prefixed w/ "#")
        if (com.kstenschke.shifter.models.shiftable.types.RbgColor.isRgbColorString(word, prefixChar)) {
            this.typeRgbColor = new com.kstenschke.shifter.models.shiftable.types.RbgColor();
            return TYPE_RGB_COLOR;
        }
        // Pixel value (must consist of numeric value followed by "px")
        if (com.kstenschke.shifter.models.shiftable.types.CssUnit.isCssUnitValue(word)) {
            this.typePixelValue = new com.kstenschke.shifter.models.shiftable.types.CssUnit();
            return TYPE_CSS_UNIT;
        }
        if (com.kstenschke.shifter.models.shiftable.types.NumericValue.isNumericValue(word)) {
            this.typeNumericValue = new com.kstenschke.shifter.models.shiftable.types.NumericValue();
        ...
        if (com.kstenschke.shifter.models.shiftable.types.StringNumericPostfix.isNumericPostfix(word)) {
        ...
        if (com.kstenschke.shifter.models.shiftable.types.StringHtmlEncodable.isHtmlEncodable(word)) {
    ...
    private boolean isKeywordAccessType(String word) {
        ...
        this.wordTypeAccessibilities = new com.kstenschke.shifter.models.shiftable.types.StaticWordType(keywordsAccessType);
        ...
        public String getShiftedWord(String word, int idWordType, boolean isUp, CharSequence editorText, int caretOffset, Integer moreCount, String filename, @Nullable Editor editor) {
            switch (idWordType) {
                ...
                case TYPE_HTML_ENCODABLE_STRING:
                    return com.kstenschke.shifter.models.shiftable.types.StringHtmlEncodable.getShifted(word);
                case TYPE_NUMERIC_POSTFIXED_STRING:
                    return com.kstenschke.shifter.models.shiftable.types.StringNumericPostfix.getShifted(word, isUp);
